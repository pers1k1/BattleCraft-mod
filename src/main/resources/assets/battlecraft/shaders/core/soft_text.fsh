...
const float SOFT_WEIGHT = 0.02;
const float GAMMA = 0.62;
const float EDGE_SOFTNESS = 3.0;
...
void main() {
    ...
    float thicken = THICKEN_LIMIT * smallText + SOFT_WEIGHT + TextWeight * WEIGHT_SHIFT;
