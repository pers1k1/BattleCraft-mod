...
public class GlassDispenserScreen extends DispenserScreen implements DimmedScreen {

    public GlassDispenserScreen(DispenserMenu menu, Inventory inventory, Component title) {
