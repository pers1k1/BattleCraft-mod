...
public class GlassShulkerBoxScreen extends ShulkerBoxScreen implements DimmedScreen {

    public GlassShulkerBoxScreen(ShulkerBoxMenu menu, Inventory inventory, Component title) {
