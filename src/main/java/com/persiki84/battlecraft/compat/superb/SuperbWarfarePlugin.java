...
// WHY: без этой проверки миксин на чужой класс валит запуск там, где SuperbWarfare не установлен:
// WHY: отсеянная здесь цель до поиска класса не доходит
public final class SuperbWarfarePlugin implements IMixinConfigPlugin {
